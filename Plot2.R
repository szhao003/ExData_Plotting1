...
#Draw plot 2
png("F:/Data Science/Data Science/CourseraClasses/ExploratoryDataAnalysis/Hw1/plot2.png", width = 480, height = 480)
plot(DateTime, as.numeric(FebData$Global_active_power), type = "l", xlab = "", ylab = "Global Active Power (kilowatts)")
dev.off () 
